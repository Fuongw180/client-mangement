...
if(isset($_POST['Submit']))
{
	...
	mysqli_query($con,"update users set fname='$fname', contactno='$contact' where id='".$_GET['uid']."'");
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Sửa thông tin người dùng <?php echo $row['fname'];?></h3>
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="lname" value="<?php echo $row['password'];?>" >
                              </div>
                          </div>
