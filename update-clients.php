...
if(isset($_POST['submit']))
{
    ...
    $msg=mysqli_query($con,"UPDATE `cdetails` SET `fname`='fname',`email`='$email,`phone`='$phone',`proofno`='$proofno',``caddress`='$caddress',`haddress`='$haddress',`rdate`='$rdate',`multiLine`='$multiLine',`depatment`='$depatment' where ID='".$_GET['uid']."'");
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <p class="centered"><a href="#"><img src="admin/assets/img/avatar.jpg" class="img-circle" width="60"></a></p>
                  <h5 class="centered"><h5 class="centered">USER</h5></h5>
